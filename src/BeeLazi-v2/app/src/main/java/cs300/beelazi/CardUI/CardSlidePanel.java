...
public class CardSlidePanel extends ViewGroup {
    ...
    private void initBottomLayout() {
        ...
        detailBtn = bottomLayout.findViewById(R.id.card_detail_btn);
        ...
        detailBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (StaticData.listSuggest != null) {
                    Intent intent;
                    String type = StaticData.listSuggest.getListModel().get(isShowing).getType();
                    if (type.equals("Food")) {
                        intent = new Intent(getContext(), DetailActivity.class);
                    } else {
                        intent = new Intent(getContext(), FilmDetailActivity.class);
                    }
                    intent.putExtra("position", String.valueOf(CardFragment.cardPosition));
...
//        else isShowing = 0;
        ...
        for (int i = 0; i < Math.min(num, dataList.size()); i++) {
