...
import cs300.beelazi.Model.EventModel;
...
//        listBuilder.setMonthLayout(R.layout.custom_month_calendar_event_layout, monthDecoratorFactory);
    ...
    private class WeeDecoratorImpl implements WeekDecorator {
        ...
        public WeeDecoratorImpl(View parent) {
            title = (TextView) parent.findViewById(R.id.week_title);
            title.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
//                    Toast.makeText(ListCalendarActivity.this, "asdasd", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ListCalendarActivity.this, AsynchronousActivity.class);
        ...
        public void onBindWeekView(View view, Pair<Calendar, Calendar> period) {
            ...
            year  = period.first.get(Calendar.YEAR);
